...
|----------|------------|-----------|--------------------------------------------------|-----------|--------------|----------|
| 1        | DRAFT      | draft     | Draft                                            | secondary | edit         | No       |
| 2        | PENDING    | pending   | Awaiting Verification                            | warning   | clock        | No       |
| 3        | VERIFIED   | verified  | Verified                                         | success   | check-circle | Yes      |
| 4        | REJECTED   | rejected  | Rejected                                         | danger    | x-circle     | No       |
...
| 2             | VERIFY    | Verify Document         | PENDING (2)| VERIFIED (3)| hr_finance_staff    | Yes              |
| 3             | REJECT    | Reject Document         | PENDING (2)| REJECTED (4)| hr_finance_staff    | Yes              |
...
|------------|------------------|
| SUBMIT     | Verification staff (hr_finance_staff) |
| VERIFY     | Document owner |
| REJECT     | Document owner |
| RESUBMIT   | Verification staff (hr_finance_staff) |
