...
class StudyRequirements extends WorkflowComponent
{
    ...
    protected $messages = [
        ...
        'selectedDocumentTypeId.required' => 'Jenis dokumen kelengkapan studi lanjut wajib dipilih.',
    ...
    public function submitDocument($documentId)
    {
        try {
            ...
            $context = [
                'user_id' => Auth::id(),
                'comment' => 'Dokumen kelengkapan studi lanjut dikirim untuk verifikasi',
                'timestamp' => now(),
            ...
            session()->flash('message', 'Dokumen kelengkapan studi lanjut berhasil dikirim untuk verifikasi.');
        } catch (\Exception $e) {
    ...
    public function uploadDocument()
    {
        try {
            ...
            session()->flash('message', 'Dokumen kelengkapan studi lanjut berhasil diunggah sebagai draft. Klik "Kirim untuk Verifikasi" untuk mengirimkan dokumen.');
    ...
    {
        return 'Status dokumen kelengkapan studi lanjut berhasil diperbarui.';
    }
