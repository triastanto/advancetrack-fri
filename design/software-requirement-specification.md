...
### 1.1 Latar Belakang
Sistem ini dikembangkan untuk mendukung proses administrasi dan monitoring studi lanjut dosen di lingkungan Fakultas Sains dan Pendidikan (FSDP). Sistem akan memfasilitasi pengelolaan data, dokumen, notifikasi, serta pelaporan yang terintegrasi dan efisien.
...
### 1.3 Lingkup
Sistem akan digunakan oleh Dosen, Staf FSDP, Kepala Urusan, dan Wakil Dekan 2 untuk mengelola data dan dokumen studi lanjut, serta mendukung proses administrasi terkait.
...
- Dosen dapat mengunggah dan memperbarui data pribadi serta dokumen kelengkapan persyaratan studi lanjut.
...
### 2.2 Verifikasi dan Administrasi oleh Staf FSDP
- Staf FSDP dapat memverifikasi dokumen persyaratan studi lanjut yang diunggah oleh dosen.
- Staf FSDP dapat mengunggah dokumen kesesuaian studi lanjut, berita acara, dan NDE permintaan studi lanjut.
- Staf FSDP dapat membaca seluruh data dan dokumen dalam sistem.
...
- Kepala Urusan dapat mengunggah dokumen perjanjian ikatan dinas yang sudah ditandatangani pemangku kepentingan.
- Dokumen perjanjian dapat diakses oleh dosen yang bersangkutan.

### 2.4 Monitoring dan Pengambilan Keputusan
- Wakil Dekan 2 dapat membaca seluruh data dan dokumen dalam sistem untuk mendukung pengambilan keputusan strategis.
...
- Sistem mengirim reminder pengisian laporan per semester (LKS) kepada dosen.
- Sistem memberikan notifikasi kepada dosen ketika PID sudah diunggah oleh staf FSDP.
