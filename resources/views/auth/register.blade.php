    ...
    <div class="w-full sm:max-w-4xl mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-6">
            ...
            <div class="bg-gray-50 p-4 rounded-lg">
                <h3 class="text-lg font-semibold text-[var(--color-text-main)] mb-4">Informasi Akun</h3>
            ...
            <div class="bg-gray-50 p-4 rounded-lg">
                <h3 class="text-lg font-semibold text-[var(--color-text-main)] mb-4">Informasi Karyawan</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative">
                            ...
                            <input id="position" name="position" type="text" value="{{ old('position') }}" required
                                   class="appearance-none block w-full pl-10 pr-3 py-2 border border-[var(--color-border)] rounded-md shadow-sm placeholder="Contoh: Dosen Teknik Industri" focus:outline-none focus:ring-[var(--color-primary)] focus:border-[var(--color-primary)] sm:text-sm">
                        </div>
                        @error('position')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative">
                            ...
                            <select id="functional_position" name="functional_position"
                                    class="appearance-none block w-full pl-10 pr-3 py-2 border border-[var(--color-border)] rounded-md shadow-sm focus:outline-none focus:ring-[var(--color-primary)] focus:border-[var(--color-primary)] sm:text-sm">
            ...
            <div class="bg-gray-50 p-4 rounded-lg">
                <h3 class="text-lg font-semibold text-[var(--color-text-main)] mb-4">Informasi Pribadi</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <div class="mt-1 relative">
                            ...
                            <input id="birth_place" name="birth_place" type="text" value="{{ old('birth_place') }}"
                                   class="appearance-none block w-full pl-10 pr-3 py-2 border border-[var(--color-border)] rounded-md shadow-sm placeholder="Contoh: Jakarta" focus:outline-none focus:ring-[var(--color-primary)] focus:border-[var(--color-primary)] sm:text-sm">
                        </div>
                        @error('birth_place')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative">
                            ...
                            <input id="contact_phone" name="contact_phone" type="tel" value="{{ old('contact_phone') }}"
                                   class="appearance-none block w-full pl-10 pr-3 py-2 border border-[var(--color-border)] rounded-md shadow-sm placeholder="Contoh: 08123456789" focus:outline-none focus:ring-[var(--color-primary)] focus:border-[var(--color-primary)] sm:text-sm">
                        </div>
                        @error('contact_phone')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative">
                            ...
                            <input id="contact_email" name="contact_email" type="email" value="{{ old('contact_email') }}"
                                   class="appearance-none block w-full pl-10 pr-3 py-2 border border-[var(--color-border)] rounded-md shadow-sm placeholder="email@example.com" focus:outline-none focus:ring-[var(--color-primary)] focus:border-[var(--color-primary)] sm:text-sm">
                        </div>
                        @error('contact_email')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                ...
                <div class="mt-4">
                    ...
                    <div class="mt-1 relative">
                        ...
                        <textarea id="origin_address" name="origin_address" rows="3"
                                  class="appearance-none block w-full pl-10 pr-3 py-2 border border-[var(--color-border)] rounded-md shadow-sm placeholder="Masukkan alamat lengkap" focus:outline-none focus:ring-[var(--color-primary)] focus:border-[var(--color-primary)] sm:text-sm">{{ old('origin_address') }}</textarea>
                    </div>
            ...
            <div class="bg-gray-50 p-4 rounded-lg">
                <h3 class="text-lg font-semibold text-[var(--color-text-main)] mb-4">Informasi Akademik</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative">
                            ...
                            <select id="research_lab_id" name="research_lab_id"
                                    class="appearance-none block w-full pl-10 pr-3 py-2 border border-[var(--color-border)] rounded-md shadow-sm focus:outline-none focus:ring-[var(--color-primary)] focus:border-[var(--color-primary)] sm:text-sm" disabled>
